    ...
    public class Database
    {
        ...
        public bool Connect()
        {
            ...
            if (Connection.State != System.Data.ConnectionState.Open)
            {
                ...
                ret = Connect(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=DB\Pujcovna.mdf;Integrated Security=True;Connect Timeout=30");
            }
            return ret;
        }
        ...
        public SqlCommand CreateCommand(string strCommand, CommandType type)
        {
